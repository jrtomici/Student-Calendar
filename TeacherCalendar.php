...
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	events.push({
			...
			url: 'http://localhost/StudentCalendar/assignments.php'

        });";
	$myfile = file_put_contents('./StudentCalendar_files/events.js', $txt.PHP_EOL , FILE_APPEND | LOCK_EX);
	}
	?>
...
<div class="modal-dialog modal-lg"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button><h4 id="myModalLabel" class="modal-title">Event</h4></div><div class="modal-body"><form action = "TeacherCalendar.php">
    <input type="hidden" name="id" value="">
    <div class="row">
	    <div class="form-group">
                                <label for="comment">Assignment name</label>
                                <input type="text" name="eventname" class="form-control" value="" placeholder="Title" id="eventname"/>
    </div>
        <div class="col-sm-3">
            <div class="form-group">
        ...
        <div class='col-sm-6'>
            <div class="form-group">
                <div class='input-group date' id='datetimepicker1'>
                    <input name='eventdate' type='text' class="form-control" id="date"/>
...
</div><div class="modal-footer"><button class="btn" data-dismiss="modal" aria-hidden="true">Close</button><input type="submit" /></div></div></div>
</form>
